...
feature = np.loadtxt(r'D:\ResearchDoc\MachineLearing\PycharmDoc\CB_inversedesign\Design_AFM_revision\all_data'
                     r'\data_abaqus_model_250624_uniaxial_z\data_all_feature_uniaxial_z.txt')
rf_z = np.loadtxt(r'D:\ResearchDoc\MachineLearing\PycharmDoc\CB_inversedesign\Design_AFM_revision\all_data'
                  r'\data_abaqus_model_250624_uniaxial_z\data_all_rf_uniaxial_z.txt')
dataset_y = rf_z
dataset_x = feature
